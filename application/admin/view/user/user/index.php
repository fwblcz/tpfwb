            ...
            <div class="ibox-content">
                <div class="table-responsive">
                    <div class="layui-btn-group conrelTable">
                        <button class="layui-btn layui-btn-sm" onclick="$eb.createModalFrame(this.innerText,'{:Url('create')}')">添加会员</button>
...
<!--                    </script>-->
                    ...
                    <script type="text/html" id="barDemo">
                        ...
                        <button class="layui-btn layui-btn-xs" lay-event="delstor"> <i class="fa fa-warning"></i> 删除 </button>
...
<script>
    ...
    layList.tableList('userList',"{:Url('get_user_list')}",function () {
        return [
                ...
                {field: 'avatar', title: '头像', event:'open_image', width: '20%', templet: '<p lay-event="open_image"><img class="avatar" style="cursor: pointer" class="open_image" data-image="{{d.avatar}}" src="{{d.avatar}}" alt="{{d.nickname}}"></p>'},
    ...
    layList.tool(function (event,data,obj) {
        ...
        switch (layEvent){
            case 'edit':
                ...
                break;
            case 'delstor':
                var url=layList.U({a:'del_user',q:{uid:data.uid}});
                var code = {title:"操作提示",text:"确定将该用户删除？",type:'info',confirm:'是的'};
