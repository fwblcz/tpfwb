...
//        $data['seckill']=self::where('seckill_id','>',0)->where('is_system_del',0)->count();
        ...
        $data['rent']=self::where('rent_id','>',0)->where('is_system_del',0)->count();
        $data['repair']=self::where('repair_id','>',0)->where('is_system_del',0)->count();
        $data['reclaim']=self::where('reclaim_id','>',0)->where('is_system_del',0)->count();
        return $data;
    }
